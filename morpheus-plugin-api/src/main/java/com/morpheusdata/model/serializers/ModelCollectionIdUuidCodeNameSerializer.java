...
public class ModelCollectionIdUuidCodeNameSerializer extends StdSerializer<Collection<MorpheusModel>> {

	// must have empty constructor
	public ModelCollectionIdUuidCodeNameSerializer() {this(null);}

	public ModelCollectionIdUuidCodeNameSerializer(Class<Collection<MorpheusModel>> t) {super(t);}
