...
public class DateUtility {
	...
	public static Date parseDateWitFormat(String dateStr, String format) throws ParseException {
		SimpleDateFormat dfInstance = new SimpleDateFormat(format);
		return dfInstance.parse(dateStr);
	}

	public static Date parseDateWitFormat(String dateStr, String format, TimeZone timezone) throws ParseException {
		SimpleDateFormat dfInstance = new SimpleDateFormat(format);
