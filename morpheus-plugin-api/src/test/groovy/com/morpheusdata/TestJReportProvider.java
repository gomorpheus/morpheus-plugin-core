...
public class TestJReportProvider extends AbstractReportProvider {
	...
	@Override
	public ServiceResponse validateOptions(Map opts) {
	 ...
	 */
	@Override
	public void process(ReportResult reportResult) {
	...
	public String getDescription() {
		return "TODO: Fill in a description";
	}
	 ...
	 * The preferred is to use server side handlebars rendering with {@link HandlebarsRenderer}
	 ...
	 */
	@Override
	public HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		ViewModel<Map<String, List<ReportResultRow>>> model = new ViewModel<>();
		model.object = reportRowsBySection;
		return getRenderer().renderTemplate("hbs/{{pluginNameInstance}}Report", model);
	}
}
