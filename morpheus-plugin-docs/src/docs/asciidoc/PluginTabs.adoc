...
Customize the UI for your Instances by providing your own tabs. https://github.com/gomorpheus/morpheus-plugin-core/tree/master/samples/morpheus-tab-plugin[Full Example]
